...
export default function Match() {
  return (
    <div className='absolute top-0 left-[316px] right-[220px] py-[138px] z-0 bg-utils-BG'>
        <Carousel>
                      ...
                      <Card className='h-[620px] rounded-[32px] overflow-hidden relative'>
                          <CardContent className="flex justify-center items-center h-full p-0">
                              <Image
                                ...
                                height={620}
                              />
                              <div className='absolute bottom-0 left-0 w-full py-14 pr-8 pl-10 flex justify-between px-4'>
